...
<body class="h-full bg-gray-50 font-sans text-gray-900 antialiased">
    <div x-data="{ sidebar: false }" class="min-h-full lg:flex">
        ...
        <aside x-cloak
               ...
               class="fixed inset-y-0 left-0 z-40 flex w-64 shrink-0 flex-col border-r border-gray-200 bg-white transition-transform duration-300 lg:translate-x-0 lg:static lg:z-auto">
            ...
            <div class="flex h-16 items-center gap-3 border-b border-gray-100 px-5">
                ...
                <div class="leading-tight">
                    <p class="text-sm font-extrabold text-brand-700">Poulet AFC</p>
                    <p class="text-[11px] text-gray-400">Administration</p>
                </div>
            </div>
            ...
            <nav class="admin-scrollbar flex-1 space-y-6 overflow-y-auto px-3 py-5">
                @foreach ($sections as [$label, $links])
                    <div>
                        <p class="px-3 pb-2 text-[10px] font-bold uppercase tracking-wider text-gray-400">{{ $label }}</p>
                                ...
                                <li>
                                    <a href="{{ route($route) }}"
                                       @class([
                                           ...
                                           'text-gray-600 hover:bg-gray-100 hover:text-brand-700' => ! $active,
                                       ])>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                             stroke="currentColor" stroke-width="1.7" class="h-5 w-5 shrink-0">
            ...
            <div class="border-t border-gray-100 p-3">
                <a href="{{ url('/') }}"
                   class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-gray-500 transition-colors duration-200 hover:bg-gray-100 hover:text-brand-700">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" class="h-5 w-5">
        ...
        <div class="flex min-w-0 flex-1 flex-col">
            ...
            <header class="sticky top-0 z-20 flex h-16 items-center gap-4 border-b border-gray-200 bg-white/90 px-4 backdrop-blur sm:px-6">
                ...
                <h1 class="min-w-0 flex-1 truncate text-base font-bold text-gray-900 sm:text-lg">{{ $title ?? 'Tableau de bord' }}</h1>

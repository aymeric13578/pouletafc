...
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#{{ $item->{'ref'} }}_banner">
Banniere
</button>
...
<div class="modal fade" id="{{ $item->{'ref'} }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">{{ $item->{'shop_name'} }}</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
  <img style="" src="{{ asset($item->{'logo'}) }}" alt="">
      </div>
      <div class="modal-footer">
...
<div class="modal fade" id="{{ $item->{'ref'} }}_banner" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">{{ $item->{'shop_name'} }}</h5>
      ...
      <div class="modal-body">
  <img style="" src="{{ asset($item->{'banner'}) }}" alt="">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>

...
<html lang="en" class="light-style layout-wide  customizer-hide" dir="ltr" data-theme="theme-semi-dark" data-assets-path="dash/assets/" data-template="vertical-menu-template-semi-dark">
...
<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{asset('dash/assets/vendor/css/rtl/core.css" class="template-customizer-core-css')}}" />
    <link rel="stylesheet" href="{{asset('dash/assets/vendor/css/rtl/theme-semi-dark.css" class="template-customizer-theme-css')}}" />
...
<link rel="stylesheet" href="{{asset('dash/assets/vendor/libs/swiper/swiper.css')}}" />
...
<link rel="stylesheet" href="{{asset('dash/assets/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css')}}">

    <!-- Page CSS -->
    <link rel="stylesheet" href="{{asset('dash/assets/vendor/css/pages/cards-advance.css')}}" />

    <!-- Helpers -->
    <script src="{{asset('dash/assets/vendor/js/helpers.js')}}"></script>
    <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
    <!--? Template customizer: To hide customizer set displayCustomizer value false in config.js.  -->
    <script src="{{asset('dash/assets/vendor/js/template-customizer.js')}}"></script>
  ...
  <div class="authentication-inner row">
    ...
    <div class="d-none d-lg-flex col-lg-7 p-0">
      <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
        <img src="{{asset('dash/assets/img/illustrations/auth-login-illustration-light.png')}}" alt="auth-login-cover" class="img-fluid my-5 auth-illustration" data-app-light-img="illustrations/auth-login-illustration-light.png" data-app-dark-img="illustrations/auth-login-illustration-dark.html">

        <img src="{{asset('dash/assets/img/illustrations/bg-shape-image-light.png')}}" alt="auth-login-cover" class="platform-bg" data-app-light-img="illustrations/bg-shape-image-light.png" data-app-dark-img="illustrations/bg-shape-image-dark.html">
      </div>
    </div>
    <!-- /Left Text -->
...
<svg width="32" height="22" viewBox="0 0 32 22" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M7.77295 16.3566L23.6563 0H32V6.88383C32 6.88383 31.8262 9.17836 30.6591 10.4057L19.7824 22H13.6938L7.77295 16.3566Z" fill="#7367F0" />
        ...
        <!-- /Logo -->
        <h3 class="mb-1">Bienvenue sur POULET AFC 👋</h3>
...
<!-- / Content -->
  ...
  <script src="{{asset('dash/assets/vendor/libs/typeahead-js/typeahead.js')}}"></script>
  ...
  <!-- Vendors JS -->
  <script src="{{asset('dash/assets/vendor/libs/%40form-validation/popular.js')}}"></script>
<script src="{{asset('dash/assets/vendor/libs/%40form-validation/bootstrap5.js')}}"></script>
<script src="{{asset('dash/assets/vendor/libs/%40form-validation/auto-focus.js')}}"></script>
  ...
  <!-- Page JS -->
  <script src="{{asset('dash/assets/js/pages-auth.js')}}"></script>

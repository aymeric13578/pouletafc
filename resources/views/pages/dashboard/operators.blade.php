        ...
        <div class="container mx-auto px-2 mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white rounded-2xl shadow-lg p-6 text-center transition transform hover:-translate-y-2 hover:shadow-2xl">
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Total Opérateurs</h3>
                    <p class="text-3xl font-bold text-indigo-600">40</p>
                </div>
                <div class="bg-white rounded-2xl shadow-lg p-6 text-center transition transform hover:-translate-y-2 hover:shadow-2xl">
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Opérateurs Actifs</h3>
                    <p class="text-3xl font-bold text-indigo-600">35</p>
                </div>
                <div class="bg-white rounded-2xl shadow-lg p-6 text-center transition transform hover:-translate-y-2 hover:shadow-2xl">
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Tâches Assignées</h3>
            ...
            <div class="flex justify-end mb-4">
                <button wire:click="openModal" class="bg-indigo-600 text-white py-2 px-6 rounded-lg hover:bg-indigo-700 transition duration-300">Ajouter Opérateur</button>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 overflow-x-auto">
                <table class="w-full text-left">
                    ...
                    <tbody>
                        @foreach ([['id' => 1, 'nom' => 'Paul Martin', 'email' => 'paul@example.com', 'role' => 'Opérateur'], ['id' => 2, 'nom' => 'Sophie Laurent', 'email' => 'sophie@example.com', 'role' => 'Manager']] as $operateur)
                            <tr class="border-b hover:bg-gray-50">
                                <td class="py-3 px-4">{{ $operateur['id'] }}</td>
                                <td class="py-3 px-4">{{ $operateur['nom'] }}</td>
                                <td class="py-3 px-4">{{ $operateur['email'] }}</td>
                                <td class="py-3 px-4">{{ $operateur['role'] }}</td>
                                <td class="py-3 px-4">
            ...
            <div wire:model="showModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center {{ $showModal ? '' : 'hidden' }}">
                <div class="bg-white rounded-lg p-6 w-full max-w-md">
                    <h2 class="text-xl font-semibold text-gray-800 mb-4">Ajouter un Opérateur</h2>
                    <form wire:submit.prevent="addOperateur">
                        <div class="mb-4">

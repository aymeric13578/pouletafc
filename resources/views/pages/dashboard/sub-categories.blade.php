        ...
        <div class="container mx-auto px-2 mt-6">
                ...
                <table class="w-full text-left">
                    ...
                    <tbody>
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4">Smartphones</td>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4">T-shirts</td>
            ...
            <div wire:model="showModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center {{ $showModal ? '' : 'hidden' }}">
                <div class="bg-white rounded-lg p-6 w-full max-w-md">
                    <h2 class="text-xl font-semibold text-gray-800 mb-4">Ajouter une Sous-catégorie</h2>
                    <form wire:submit.prevent="addSousCategorie">
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 mb-2" for="categorie_id">Catégorie Parente</label>
                            <select id="categorie_id" wire:model="categorie_id" class="w-full p-2 border rounded-lg" required>

...
new class extends Component {
    ...
    public function closeModal()
    {
        ...
        $this->reset(['service', 'agent', 'statut']);
    }

    public function addClando()
    {
        ...
        <div class="container mx-auto px-2 mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white rounded-2xl shadow-lg p-6 text-center transition transform hover:-translate-y-2 hover:shadow-2xl">
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Total Services Clando</h3>
                    <p class="text-3xl font-bold text-indigo-600">300</p>
                </div>
                <div class="bg-white rounded-2xl shadow-lg p-6 text-center transition transform hover:-translate-y-2 hover:shadow-2xl">
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Services Actifs</h3>
                    <p class="text-3xl font-bold text-indigo-600">250</p>
                </div>
                <div class="bg-white rounded-2xl shadow-lg p-6 text-center transition transform hover:-translate-y-2 hover:shadow-2xl">
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Revenu Total</h3>
                    <p class="text-3xl font-bold text-indigo-600">3000 FCFA</p>
                </div>
            </div>

            <!-- Add Button -->
            <div class="flex justify-end mb-4">
                <button wire:click="openModal" class="bg-indigo-600 text-white py-2 px-6 rounded-lg hover:bg-indigo-700 transition duration-300">Ajouter Service Clando</button>
            </div>
                ...
                <table class="w-full text-left">
                    <thead>
                        <tr class="border-b">
                            ...
                            <th class="py-3 px-4 text-gray-800">Service</th>
                    ...
                    <tbody>
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4">Transport</td>
                            <td class="py-3 px-4">Agent 1</td>
                            <td class="py-3 px-4">Actif</td>
                            <td class="py-3 px-4">
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4">Livraison</td>
                            <td class="py-3 px-4">Agent 2</td>
                            <td class="py-3 px-4">Inactif</td>
                            <td class="py-3 px-4">
                                <button class="text-indigo-600 hover:underline">Modifier</button>
                                <button class="text-red-600 hover:underline ml-2">Supprimer</button>
                            </td>
            ...
            <div wire:model="showModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center {{ $showModal ? '' : 'hidden' }}">
                <div class="bg-white rounded-lg p-6 w-full max-w-md">
                    <h2 class="text-xl font-semibold text-gray-800 mb-4">Ajouter un Service Clando</h2>
                    <form wire:submit.prevent="addClando">
                        <div class="mb-4">
                            <label class="block text-gray-700 mb-2" for="service">Service</label>
                            <input type="text" id="service" wire:model="service" class="w-full p-2 border rounded-lg" required>
                        </div>
                        <div class="mb-4">
                            <label class="block text-gray-700 mb-2" for="agent">Agent</label>
                            <select id="agent" wire:model="agent" class="w-full p-2 border rounded-lg" required>

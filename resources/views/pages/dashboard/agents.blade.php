        ...
        <div class="container mx-auto px-2 mt-6">
                ...
                <table class="w-full text-left">
                    <thead>
                        <tr class="border-b">
                            ...
                            <th class="py-3 px-4 text-gray-800">Tâches</th>
                    ...
                    <tbody>
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4">agent1@example.com</td>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4">agent2@example.com</td>
            ...
            <div wire:model="showModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center {{ $showModal ? '' : 'hidden' }}">
                <div class="bg-white rounded-lg p-6 w-full max-w-md">
                    <h2 class="text-xl font-semibold text-gray-800 mb-4">Ajouter un Agent</h2>

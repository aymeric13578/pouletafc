...
new class extends Component {
    ...
    public function closeModal()
    {
        ...
        $this->reset(['client', 'produits', 'statut']);
    }
        ...
        <div class="container mx-auto px-2 mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 text-center transition transform hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <p class="text-3xl font-bold text-indigo-600">5000 FCFA</p>
                </div>
            </div>

            <!-- Add Button -->
            <div class="flex justify-end mb-4">
                <button wire:click="openModal" class="bg-indigo-600 text-white py-2 px-6 rounded-lg hover:bg-indigo-700 transition duration-300">Ajouter Commande</button>
            </div>
                ...
                <table class="w-full text-left">
                    ...
                    <tbody>
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4">9000 FCFA</td>
            ...
            <div wire:model="showModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center {{ $showModal ? '' : 'hidden' }}">
                <div class="bg-white rounded-lg p-6 w-full max-w-md">
                    <h2 class="text-xl font-semibold text-gray-800 mb-4">Ajouter une Commande</h2>
                    <form wire:submit.prevent="addCommande">
                        <div class="mb-4">
                            ...
                            <select id="client" wire:model="client" class="w-full p-2 border rounded-lg" required>
                                ...
                                <option value="marie">Marie Curie</option>
                            </select>
                        </div>
                        <div class="mb-4">
                            <label class="block text-gray-700 mb-2" for="produits">Produits</label>
                            <select id="produits" wire:model="produits" multiple class="w-full p-2 border rounded-lg">
                                <option value="produit_a">Produit A</option>
                                <option value="produit_b">Produit B</option>
                            </select>
                        </div>
                        <div class="mb-4">

        ...
        <div class="container mx-auto px-2 mt-6">
                ...
                <table class="w-full text-left">
                    <thead>
                        <tr class="border-b">
                            ...
                            <th class="py-3 px-4 text-gray-800">Description</th>
                    ...
                    <tbody>
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4">Appareils électroniques</td>
                            <td class="py-3 px-4">
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4">Mode et accessoires</td>
                            <td class="py-3 px-4">
                                <button class="text-indigo-600 hover:underline">Modifier</button>
                                <button class="text-red-600 hover:underline ml-2">Supprimer</button>
                            </td>
            ...
            <div wire:model="showModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center {{ $showModal ? '' : 'hidden' }}">
                <div class="bg-white rounded-lg p-6 w-full max-w-md">
                    ...
                    <form wire:submit.prevent="addCategorie">
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" wire:model="description" class="w-full p-2 border rounded-lg" required></textarea>
                        </div>

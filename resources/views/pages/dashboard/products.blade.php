...
new class extends Component {
    ...
    public function closeModal()
    {
        ...
        $this->reset(['nom', 'categorie', 'prix', 'stock']);
    }

    public function addProduit()
    {
        // Placeholder : Réinitialise le formulaire sans sauvegarder
        $this->closeModal();
    }
};
?>
    ...
    @volt
        <div class="container mx-auto px-2 mt-6">
            ...
            <div class="flex justify-end mb-4">
                <button wire:click="openModal" class="bg-indigo-600 text-white py-2 px-6 rounded-lg hover:bg-indigo-700 transition duration-300">Ajouter Produit</button>
            </div>
                ...
                <table class="w-full text-left">
                    <thead>
                        <tr class="border-b">
                            ...
                            <th class="py-3 px-4 text-gray-800">Prix</th>
                    ...
                    <tbody>
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4">Produit A</td>
                            <td class="py-3 px-4">Électronique</td>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4">Produit B</td>
                            <td class="py-3 px-4">Vêtements</td>
            ...
            <div wire:model="showModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center {{ $showModal ? '' : 'hidden' }}">
                <div class="bg-white rounded-lg p-6 w-full max-w-md">
                    ...
                    <form wire:submit.prevent="addProduit">
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 mb-2" for="categorie">Catégorie</label>
                            <select id="categorie" wire:model="categorie" class="w-full p-2 border rounded-lg" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="prix" wire:model="prix" step="0.01" class="w-full p-2 border rounded-lg" required>
                        </div>
                        <div class="mb-4">
                            <label class="block text-gray-700 mb-2" for="stock">Stock</label>
                            <input type="number" id="stock" wire:model="stock" class="w-full p-2 border rounded-lg" required>
                        </div>

...
export default function CarteLivraisons({ initial }) {
     ...
     * l'opérateur ouvre le menu d'attribution d'une commande précise — pas à
    ...
    useEffect(() => {
        ...
        fetch(`/commandes/carte/${attribution}/agents-classes`, { headers: { Accept: 'application/json' } })
                                                ...
                                                <div className="px-4 pb-3">
                                                    {attribution === o.id ? (
                                                        <ChoixAgent
                                                            ...
                                                            classement={attribution === o.id ? classementAgents : null}

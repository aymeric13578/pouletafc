...
class ProductController extends Controller
{
    ...
    public function listProduct()
    {
        ...
        // dd($listProducts);
        return view('merchand.products.product_list', ['listProducts' => $listProducts]);
    }
    ...
    public function addProduct()
    {
        ...
        return view('merchand.products.add_product', compact('categories', 'shops'));
    }
    public function cathegoryProduct()
    {
        return view('merchand.products.product_category');
    }
    ...
    public function editProductImg($id)
    {
        ...
        return view('merchand.products.edit-product-img', compact('productInfo'));
    }
    ...
    public function updateProductImg(Request $request)
    {
        ...
        return redirect()->route('merchandlistProduct')->with('message', 'Image modifiée avec succès!');
    }
    ...
    public function editProduct($id)
    {
        $productInfo = Product::findOrFail($id);
        $categories = Category::latest()->get();
        return view('merchand.edit_product', compact('productInfo', 'categories'));
    }
    ...
    public function updateProduct(Request $request)
    {
        ...
        return redirect()->route('merchandlistProduct')->with('message', 'Produit modifié avec succès!');
    }
    ...
    public function deleteProduct($id)
    {
        ...
        return redirect()->route('merchandlistProduct')->with('message', 'Produit supprimé avec succès!');
    }

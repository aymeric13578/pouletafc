...
class ShopController extends Controller
{
    ...
    public function storeshop(Request $request)
    {
        ...
        $shop_banner_name = hexdec(uniqid()) . '.' . $shop_banner->getClientOriginalExtension();
        ...
        Shop::insert([
            ...
            'banner' =>"https://pouletafc.2gether-network.com/".$shop_banner_url,
            'type' => $request->{'type'},
            'phone1' => $request->{'shop_telephone1'},
            'email1' => $request->{'shop_email1'},
            'logo' => "https://pouletafc.2gether-network.com/".$shop_logo_url,
            'slug' => strtolower(str_replace(' ', '-', $request->{'shop_name'})),
            'commercial_register' => $request->{'shop_commercial_register'},
            'commercial_register_file' => "https://pouletafc.2gether-network.com/".$registry_file_url,

...
class SubCategoryController extends Controller
{
    ...
    public function subCategoryList()
    {
        ...
        return view('admin.sub-categories.sub-category-list', ['subCategories' => $subCategories]);
    }
    ...
    public function addSubCategory()
    {
        $categories = DB::table('categories')
            ->orderBy('id', 'desc')
            ->get();
        return view('admin.sub-categories.add-sub-category', ['categories' => $categories]);
    }
    ...
    public function storeSubCategory(Request $request)
    {
        ...
        return redirect()->route('subcategorylist')->with('message', 'Sous-catégorie ajoutée avec succès!');
    }
